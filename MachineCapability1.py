...
class Ui_MachineCap(object):
    ...
    def MachCapDB(self):
        ...
        if(len(MachCapID) == 0 and \
            ...
            self.showMCMessageBox("Machine Capability","Please Enter Details!")
            print("Please Enter Details!")

        elif(len(MachCapID) == 0 and \
            len(MachCapDate) == 0 ):
            self.showMCMessageBox("Machine Capability","Please Enter all Details!")
            print("Please Enter Details!")
    ...
    def onClickMCDB(self):
        try:
            ...
            self.showMCMessageBox("Machine Capability","Details Exists !")
    ...
    def retranslateUi(self, MachineCap):
        ...
        self.groupBox.setTitle(_translate("MachineCap", "Insert Machine Capapbility Details"))
        self.label.setText(_translate("MachineCap", "Machine Capability ID :"))
        self.label_2.setText(_translate("MachineCap", "Date of Machine Capapbility :"))
        self.label_7.setText(_translate("MachineCap", "Date of Machine Capapbility Remainder :"))
        self.pushButton.setText(_translate("MachineCap", "SUBMIT"))
        self.groupBox_2.setTitle(_translate("MachineCap", "Edit Machine Capapbility Details"))
        self.label_3.setText(_translate("MachineCap", "Machine Capability ID :"))
        self.label_4.setText(_translate("MachineCap", "Date of Machine Capapbility :"))
        self.label_6.setText(_translate("MachineCap", "Date of Machine Capapbility Remainder :"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MachineCap", "Show Machine Capapbilty Date"))
